import { r as registerInstance, k as createEvent, o as Build, h, j as getElement } from './index-a9bdaee2.js';
import { g as getIonMode, c as config } from './ionic-global-9fb5c7c7.js';
import { g as getTimeGivenProgression } from './cubic-bezier-a7ad9c8e.js';
import { l as assert } from './helpers-2e36c018.js';
import { l as lifecycle, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE, t as transition, s as setPageHidden } from './index-3215dd9c.js';
import { a as attachComponent } from './framework-delegate-cd195189.js';
...
let Nav = class {
  ...
  async componentDidLoad() {
    this.rootChanged();
    this.gesture = (await import('./swipe-back-edebb8ca.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
