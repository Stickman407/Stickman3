...
const idb$1 = /*@__PURE__*/getDefaultExportFromCjs(idb);
...
let PageHome = class {
  ...
  render() {
    return [
      ...
      h("div", { class: "scoreboard" }, h("button", { onClick: () => this.logout() }, "logout"), !this.isLoggedIn && h("ion-button", { onClick: () => this.signInWithGoogle() }, "Login with Google"), h("span", null, "P1: ", this.p1Score), h("span", null, "P2: ", this.p2Score)),
      h("div", { class: "map" }, h("stick-tank", { ref: (p1) => this.p1 = p1 }), h("tank-1", { ref: (p2) => this.p2 = p2 }), this.obstacles.map(obstacle => obstacle.health > 0 &&
