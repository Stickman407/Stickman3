import { l as writeTask, r as registerInstance, k as createEvent, m as forceUpdate, h, i as Host, j as getElement, n as readTask } from './index-a9bdaee2.js';
import { g as getIonMode, c as config, a as isPlatform } from './ionic-global-9fb5c7c7.js';
import { h as hapticSelectionStart, a as hapticSelectionChanged, b as hapticSelectionEnd } from './haptic-267cb79b.js';
import { createGesture } from './index-c31991b6.js';
import { g as getClassMap, c as createColorClasses } from './theme-c336c9d9.js';
import { c as createAnimation } from './animation-61bb797b.js';
import { s as sanitizeDOMString } from './index-435af8e6.js';
import { B as Backdrop } from './backdrop-18f9b37f.js';
import { C as CoreDelegate, a as attachComponent, d as detachComponent } from './framework-delegate-cd195189.js';
import { c as clamp, g as getElementRoot, r as raf, a as addEventListener, d as componentOnReady, f as focusElement, b as removeEventListener } from './helpers-2e36c018.js';
import { d as deepReady } from './index-3215dd9c.js';
import { g as getTimeGivenProgression } from './cubic-bezier-a7ad9c8e.js';
import { P as PickerColumnCmp } from './picker-column-daef9d7f.js';
import { R as RippleEffect } from './ripple-effect-314daaea.js';
import { S as Spinner } from './spinner-7689dd82.js';
import { OVERLAY_BACK_BUTTON_PRIORITY } from './hardware-back-button-b6ccf74a.js';
...
let Alert = class {
   ...
   */
  present() {
    return present(this, 'alertEnter', iosEnterAnimation$6, mdEnterAnimation$5);
  }
  /**
   ...
   */
  dismiss(data, role) {
    return dismiss(this, data, role, 'alertLeave', iosLeaveAnimation$6, mdLeaveAnimation$5);
  }
  /**
  ...
  renderAlertButtons() {
    ...
    return (h("div", { class: alertButtonGroupClass }, buttons.map(button => h("button", { type: "button", id: button.id, class: buttonClass$3(button), tabIndex: 0, onClick: () => this.buttonClick(button) }, h("span", { class: "alert-button-inner" }, button.text), mode === 'md' && h("ion-ripple-effect", null)))));
  }
  render() {
...
let Loading = class {
   ...
   */
  async present() {
    await present(this, 'loadingEnter', iosEnterAnimation$5, mdEnterAnimation$4, undefined);
    if (this.duration > 0) {
  ...
  dismiss(data, role) {
    ...
    return dismiss(this, data, role, 'loadingLeave', iosLeaveAnimation$5, mdLeaveAnimation$4);
  }
  /**
 ...
 */
const iosEnterAnimation$4 = (baseEl, opts) => {
 ...
 */
const iosLeaveAnimation$4 = (baseEl, opts, duration = 500) => {
  const { presentingEl, currentBreakpoint } = opts;
  const root = getElementRoot(baseEl);
 ...
 */
const mdLeaveAnimation$3 = (baseEl, opts) => {
  const { currentBreakpoint } = opts;
  const root = getElementRoot(baseEl);
...
let Modal = class {
  ...
  async present() {
    ...
    this.currentTransition = present(this, 'modalEnter', iosEnterAnimation$4, mdEnterAnimation$3, { presentingEl: this.presentingElement, currentBreakpoint: this.initialBreakpoint, backdropBreakpoint: this.backdropBreakpoint });
    await this.currentTransition;
  ...
  initSwipeToClose() {
    ...
    const animationBuilder = this.leaveAnimation || config.get('modalLeave', iosLeaveAnimation$4);
  ...
  initSheetGesture() {
    ...
    const animationBuilder = this.enterAnimation || config.get('modalEnter', iosEnterAnimation$4);
  ...
  async dismiss(data, role) {
    ...
    this.currentTransition = dismiss(this, data, role, 'modalLeave', iosLeaveAnimation$4, mdLeaveAnimation$3, { presentingEl: this.presentingElement, currentBreakpoint: this.currentBreakpoint || this.initialBreakpoint, backdropBreakpoint: this.backdropBreakpoint });
...
let Picker = class {
   ...
   */
  async present() {
    await present(this, 'pickerEnter', iosEnterAnimation$3, iosEnterAnimation$3, undefined);
    if (this.duration > 0) {
  ...
  dismiss(data, role) {
    ...
    return dismiss(this, data, role, 'pickerLeave', iosLeaveAnimation$3, iosLeaveAnimation$3);
  }
  /**
...
let Popover = class {
  ...
  async present(event) {
    ...
    this.configureDismissInteraction();
    this.currentTransition = present(this, 'popoverEnter', iosEnterAnimation$2, mdEnterAnimation$2, {
  ...
  async dismiss(data, role, dismissParentPopover = true) {
    ...
    this.currentTransition = dismiss(this, data, role, 'popoverLeave', iosLeaveAnimation$2, mdLeaveAnimation$2, this.event);
...
let Toast = class {
   ...
   */
  async present() {
    await present(this, 'toastEnter', iosEnterAnimation$1, mdEnterAnimation$1, this.position);
    if (this.duration > 0) {
  ...
  dismiss(data, role) {
    ...
    return dismiss(this, data, role, 'toastLeave', iosLeaveAnimation$1, mdLeaveAnimation$1, this.position);
  }
  /**
  ...
  renderButtons(buttons, side) {
    ...
    return (h("div", { class: buttonGroupsClasses }, buttons.map(b => h("button", { type: "button", class: buttonClass$1(b), tabIndex: 0, onClick: () => this.buttonClick(b), part: "button" }, h("div", { class: "toast-button-inner" }, b.icon &&
...
export { ActionSheet as A, Loading as L, Modal as M, Picker as P, Toast as T, Alert as a, actionSheetController as b, alertController as c, Popover as d, popoverController as p, safeCall as s };
